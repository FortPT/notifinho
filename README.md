...
<a href="https://github.com/FortPT/notifinho/releases">
  <img src="https://img.shields.io/badge/stable-v2.3.6-blue" alt="Stable release v2.3.6">
</a>
...
See the [v2.3.6 release notes](docs/releases/v2.3.6.md) for the scoped
Overview icon sizing and official Redfish identity correction. The complete
operator walkthrough is in the
[v2.3.6 acceptance checklist](docs/v2.3.6-acceptance-checklist.md).
